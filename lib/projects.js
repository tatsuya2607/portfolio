...
export const projects = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "image", src: "/works/aura/tech.webp", alt: "Engineering section showing the exploded internal structure" },
    ],
    stack: {
    ...
    en: {
      ...
      overview: [
        ...
        "Eight sections alternate between dark and light to set a rhythm, and the copy leads with experience rather than spec sheets. Every visual flourish has a reduced-motion fallback, so the page stays calm and usable when the viewer prefers less movement.",
      ],
      features: [
    ...
    ja: {
      ...
      overview: [
        ...
        "8つのセクションをダーク／ライトで交互に並べてリズムを作り、文言はスペックの羅列ではなく体験から語ります。すべての演出に「動きを抑える」フォールバックを用意し、prefers-reduced-motion 環境でも落ち着いて使えるようにしました。",
      ],
      features: [
