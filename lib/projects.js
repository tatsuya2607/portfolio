...
export const projects = [
  {
    ...
    media: [
      { type: "video", src: "/works/gmail/gmail-ai-demo.mp4", poster: "/works/gmail/poster.webp", alt: "Opening a Gmail message and generating a Claude-written reply on a single screen" },
    ],
    stack: {
