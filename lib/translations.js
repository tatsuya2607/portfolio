    ...
    works: {
      ...
      cards: {
        ...
        aura: {
          ...
          desc: "An Apple-style product landing page for a fictional pair of wireless earbuds, hand-built as a single static page with looping-free product video, scroll-reveal animations, a canvas noise field, and animated count-up stats.",
        },
        planner: {
          title: "Notion AI Task Planner",
          desc: "A serverless automation (GitHub Actions cron) that reads my calendar, tasks, and goals, then has Claude draft a time-blocked daily plan into Notion — plus nightly progress tracking and phone-based capture.",
        },
        aoba: {
          title: "Aoba Clinic Website",
          desc: "A corporate site for a fictional gastroenterology & endoscopy clinic. Multi-page and SSG with a mobile-first Tailwind design, news/blog editable via microCMS (local fallback), and built-in SEO — MedicalClinic JSON-LD and sitemap.",
        },
      },
    },
    contact: {
    ...
    works: {
      ...
      cards: {
        ...
        aura: {
          ...
          desc: "架空のワイヤレスイヤホンのApple系プロダクトLP。フレームワークを使わず1枚の静的ページとして制作し、製品動画・スクロール演出・Canvasのノイズ表現・カウントアップを実装。",
        },
        planner: {
          title: "Notion AI タスクプランナー",
          desc: "GitHub Actions の cron だけで動くサーバーレス自動化。カレンダー・タスク・目標を読み取り、Claude が時間割を生成して Notion に書き込む。夜間の進捗集計とスマホからの入力にも対応。",
        },
        aoba: {
          title: "あおばクリニック サイト",
          desc: "架空の消化器内科・内視鏡クリニックのコーポレートサイト。複数ページ・SSG、モバイルファーストの Tailwind デザインで、お知らせ／ブログは microCMS で更新可能（ローカルfallback付き）。MedicalClinic JSON-LD や sitemap などSEOも作り込み。",
        },
      },
    },
    contact: {
